...
\newcommand{\unt}{^\times}
\newcommand{\nsub}{\trianglelefteq}
\let\oldrtimes\rtimes
\renewcommand{\rtimes}{%
  \mathbin{\raisebox{-0.15ex}{\scalebox{1}[1.4]{$\oldrtimes$}}}%
}
...
\newcommand{\hint}[1]{\textcolor{ForestGreen}{\textsc{Hint.}} \textit{#1}}
\newcommand{\remark}[1]{\textcolor{RedViolet}{\textsc{Remark.}} \textit{#1}}
\newcommand{\up}{\vspace{-0.3cm}}
\newcommand{\down}{\vskip 0.2cm}
\newcommand{\squad}{\hspace{0.5em}}
\renewcommand{\emptyset}{\varnothing}
\RenewDocumentCommand{\bar}{m O{}}{\widebar{#1}{}^{#2}}
\NewDocumentCommand{\dbar}{m O{}}{\widebar{#1}{}_{#2}}
