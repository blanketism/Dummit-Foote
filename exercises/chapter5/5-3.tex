...
\begin{sol}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item $Z_4 * D_8$ has no elements of order 8, since taking quotients only preserves divisibility of orders from $Z_4 \times D_8$, which has no elements of order 8, while $D_{16}$ does.
	...
	Then only $k = 4$ works, giving $M$ a total of 3 elements of order 2.
        ...
        \begin{itemize}
            ...
            \item Note that $\bar{(x^k, q)} \in Z_4 * Q_8 \cong Z_4 * D_8$ has order 2 when $(x^k, q)^2 = (1, 1)$ or $(x^2, -1)$.
	...
	The other case of $q^2 = -1$ and $2i \equiv 2 \bmod 4$, or $i$ odd and $q = Q_8 \setminus Z(Q_8)$ gives 6 elements of order 2, for a total of 7 elements of order 2 in $Z_4 * D_8$, while $Z_2 \times D_8$ has 11 elements of order 2.
