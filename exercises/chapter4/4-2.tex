...
\begin{solenum}
	...
	Since $|\ocal_a|$ divides $|A| \leq 7$, then $|\ocal_a|$ must be 1, 2, 4, or 7.
	However, since $Q_8$ has no subgroup of index 7, then $|\ocal_a|$ cannot be 7.
...
\begin{sol}
	...
	Since $\abs x = n$, then $|\ocal_g| = n$ for all $g \in G$.
	...
	Since $|\ocal_g| = n$, then $(\langle x \rangle)_g$ is trivial for all $g \in G$.
