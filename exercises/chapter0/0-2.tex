...
\begin{sol}
    \[
        a\left(x_0 + \frac bdt\right) + b\left(y_0 - \frac adt\right) = ax_0 + by_0 + \frac{abt}{d} - \frac{abt}{d} = N. \qh
    \]
\end{sol}
...
\begin{sol}
    Without loss of generality, suppose there exist nonzero integers $a, b$ such that $a^2 = pb^2$ and $(a, b) = 1$.
